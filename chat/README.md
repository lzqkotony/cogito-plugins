...
这个目录放着 Cogito 从零到现在（v0.5.20）的完整对话记录。
...
| `transcript-2026-09-20-0.5.11.md` | 第十六轮：修正免伤顺序、6 秒悬空与空挥范围攻击，加入服主 E.G.O. 获取白名单 |
| `transcript-2026-09-21-0.5.12.md` | 第十七轮：失乐园改为 `±8` 立方体范围，排除本人/使徒友伤并修复右键锄地 |
| `transcript-2026-09-21-0.5.13.md` | 第十八轮：失乐园改为结算前免疫单次原始伤害 `≤5` |
| `transcript-2026-09-22-0.5.14.md` | 第十九轮：允许鞘翅功能性混搭，并增加黄盾 ActionBar 数值显示 |
| `transcript-2026-09-22-0.5.15.md` | 第二十轮：排查黄盾不扣减，增加首次充能与每次扣盾前的 Y=4 校验 |
| `transcript-2026-09-22-0.5.16.md` | 第二十一轮：完全删除失乐园单次伤害免疫 |
| `transcript-2026-09-22-0.5.17.md` | 第二十二轮：新增拟态 E.G.O. 三阶段、模仿层与右键技能 |
| `transcript-2026-09-22-0.5.18.md` | 第二十三轮：恢复失乐园四件套的原始伤害 `<5` 免疫 |
| `transcript-2026-09-25-0.5.19.md` | 第二十四轮：按原著将失乐园原始伤害免伤阈值提高到 `≤10` |
| `transcript-2026-09-25-0.5.20.md` | 第二十五轮：保护 Citizens NPC，复活被服主剑误杀的 EULA NPC |
