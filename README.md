...
```bash
mvn clean package                       # 产物：target/Cogito-0.5.2.jar
...
| v0.5.2 | 正义裁决者统一命名、PALE 蓝伤百分比、满蓄力挥剑触发 8~10 段范围伤害、修正套装攻速叠加 | ✅ 本版 |
| v0.5.x | 同一功能线的修复与小功能：E.G.O. 使用代价、共鸣、饰品四部位…… | 🚧 下一个 0.5.3 起 |
