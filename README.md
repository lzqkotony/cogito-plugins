...
```bash
mvn clean package                       # 产物：target/Cogito-0.5.3.jar
...
| v0.5.3 | 改用手臂挥动事件触发正义裁决者、服主剑左键击杀、未装载蓝图装备仍显示、正义裁决者全套铁甲+钻石海岸纹饰 | ✅ 本版 |
| v0.5.x | 同一功能线的修复与小功能：E.G.O. 使用代价、共鸣、饰品四部位…… | 🚧 下一个 0.5.4 起 |
